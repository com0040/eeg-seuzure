# -*- coding: utf-8 -*-
"""
Created on Mon Jul 11 10:44:45 2022
...
def load_csv_by_path(input_path,output_path): # 경로에 있는 csv불러오기
    ...
    return pid, filename_csv, output_path, pid_without_overrap
    # 내보낼 변수 
...
def repeat_pid_without_overrap_length(input_path,output_path):
    pid,filename_csv,output_path, pid_without_overrap = load_csv_by_path(input_path, output_path)
    i=1
...
repeat_pid_without_overrap_length(input_path,output_path)
